...
DEFINE DYNAMIC TABLE {{ db }}.{{ crm_agg }}.EMPA_AGG_DT_ADVISOR_PERFORMANCE(
 ...
 TEAM_LEADER_NAME VARCHAR(201),

 TOTAL_CLIENTS NUMBER(10,0),
 HIGH_RISK_CLIENTS NUMBER(10,0),
 HIGH_RISK_PERCENTAGE NUMBER(10,2),

 TOTAL_PORTFOLIO_VALUE NUMBER(18,2),
 AVG_CLIENT_BALANCE NUMBER(18,2),
 MAX_CLIENT_BALANCE NUMBER(18,2),

 TOTAL_CLIENT_ACCOUNTS NUMBER(10,0),
 AVG_ACCOUNTS_PER_CLIENT NUMBER(10,2),

 TOTAL_TRANSACTIONS NUMBER(10,0),
 AVG_TRANSACTIONS_PER_CLIENT NUMBER(10,2),

 CRITICAL_RISK_CLIENTS NUMBER(10,0),
 HIGH_RISK_CLIENTS_CLASSIFICATION NUMBER(10,0),

 MOST_RECENT_ASSIGNMENT DATE,
 FIRST_ASSIGNMENT DATE,

 CAPACITY_UTILIZATION_PCT NUMBER(10,2),
...
DEFINE DYNAMIC TABLE {{ db }}.{{ crm_agg }}.EMPA_AGG_DT_PORTFOLIO_BY_ADVISOR(
 ADVISOR_EMPLOYEE_ID VARCHAR(20),
 ADVISOR_NAME VARCHAR(201),
 COUNTRY VARCHAR(50),
 REGION VARCHAR(50),
 ...
 AVG_AUM_PER_CLIENT NUMBER(18,2),

 AUM_USD NUMBER(18,2),
 AUM_EUR NUMBER(18,2),
 AUM_GBP NUMBER(18,2),
 AUM_CHF NUMBER(18,2),
 AUM_OTHER NUMBER(18,2),

 PREMIUM_CLIENTS NUMBER(10,0),
 PLATINUM_CLIENTS NUMBER(10,0),
 GOLD_CLIENTS NUMBER(10,0),
...
DEFINE DYNAMIC TABLE {{ db }}.{{ crm_agg }}.EMPA_AGG_DT_TEAM_LEADER_DASHBOARD(
 ...
 REGION VARCHAR(50),
 HIRE_DATE DATE,
 TL_PERFORMANCE_RATING DECIMAL(3,2),

 SUPER_LEADER_ID VARCHAR(20),
 SUPER_LEADER_NAME VARCHAR(201),

 TOTAL_ADVISORS NUMBER(10,0),
 ACTIVE_ADVISORS NUMBER(10,0),

 AVG_ADVISOR_PERFORMANCE NUMBER(5,2),
 MIN_ADVISOR_PERFORMANCE DECIMAL(3,2),
 MAX_ADVISOR_PERFORMANCE DECIMAL(3,2),

 TOTAL_CLIENTS NUMBER(10,0),
 HIGH_RISK_CLIENTS NUMBER(10,0),

 TOTAL_TEAM_AUM NUMBER(18,2),
 AVG_CLIENT_BALANCE NUMBER(18,2),

 AVG_CLIENTS_PER_ADVISOR NUMBER(10,1),

 TEAM_CAPACITY_UTILIZATION_PCT NUMBER(10,2),
 TEAM_AVAILABLE_CAPACITY NUMBER(10,0),

 COUNTRIES_COVERED NUMBER(10,0),
 COUNTRY_LIST VARCHAR(2000)
)
