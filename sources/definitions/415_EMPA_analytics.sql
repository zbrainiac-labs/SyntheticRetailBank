...
LEFT JOIN CRMA_AGG_DT_CUSTOMER_CURRENT c 
...
LEFT JOIN {{ crm_raw }}.EMPI_RAW_TB_CLIENT_ASSIGNMENT a 
    ...
    AND a.IS_CURRENT = TRUE
LEFT JOIN CRMA_AGG_DT_CUSTOMER_CURRENT c ON a.CUSTOMER_ID = c.CUSTOMER_ID
...
FROM {{ crm_raw }}.EMPI_RAW_TB_CLIENT_ASSIGNMENT a
JOIN CRMA_AGG_DT_CUSTOMER_CURRENT c ON a.CUSTOMER_ID = c.CUSTOMER_ID
JOIN {{ crm_raw }}.EMPI_RAW_TB_EMPLOYEE e ON a.ADVISOR_EMPLOYEE_ID = e.EMPLOYEE_ID
