...
WITH customer_base AS (
    SELECT 
        ...
        c.CURRENT_FROM AS CUSTOMER_CREATED_DATE
    FROM {{ db }}.{{ crm_agg }}.CRMI_AGG_DT_CUSTOMER_PII pii
    JOIN {{ db }}.{{ crm_agg }}.CRMA_AGG_DT_CUSTOMER_CURRENT c ON pii.CUSTOMER_ID = c.CUSTOMER_ID
    LEFT JOIN {{ db }}.{{ crm_agg }}.CRMA_AGG_DT_ADDRESSES_CURRENT a ON pii.CUSTOMER_ID = a.CUSTOMER_ID
),
exact_matches AS (
    SELECT 
        c.CUSTOMER_ID,
