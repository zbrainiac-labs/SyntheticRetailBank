...
FROM REPP_AGG_DT_LCR_DAILY
WHERE AS_OF_DATE = (SELECT MAX(AS_OF_DATE) FROM REPP_AGG_DT_LCR_DAILY);
...
FROM REPP_AGG_DT_LCR_OUTFLOW o
CROSS JOIN latest_date ld
