...
DEFINE TABLE {{ db }}.{{ pay_raw }}.PAYI_RAW_TB_TRANSACTIONS (
 ...
 AMOUNT DECIMAL(15,2) NOT NULL WITH TAG ({{ db }}.PUBLIC.SENSITIVITY_LEVEL='restricted'),
 CURRENCY VARCHAR(3) NOT NULL,
 BASE_AMOUNT DECIMAL(15,2) NOT NULL WITH TAG ({{ db }}.PUBLIC.SENSITIVITY_LEVEL='restricted'),
 BASE_CURRENCY VARCHAR(3) NOT NULL,
 FX_RATE DECIMAL(15,6) NOT NULL,
 COUNTERPARTY_ACCOUNT VARCHAR(100) NOT NULL WITH TAG ({{ db }}.PUBLIC.SENSITIVITY_LEVEL='restricted'),
 DESCRIPTION VARCHAR(500) NOT NULL WITH TAG ({{ db }}.PUBLIC.SENSITIVITY_LEVEL='restricted'),
