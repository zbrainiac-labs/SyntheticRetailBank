DEFINE DYNAMIC TABLE {{ db }}.{{ pay_agg }}.PAYA_AGG_DT_TRANSACTION_ANOMALIES(
 ...
 CUSTOMER_TOTAL_TRANSACTIONS NUMBER(10,0),
 AVG_TRANSACTION_AMOUNT DECIMAL(15,2),
 MEDIAN_TRANSACTION_AMOUNT DECIMAL(15,2),
 AVG_DAILY_TRANSACTION_COUNT NUMBER(8,2),
 AMOUNT_ANOMALY_SCORE NUMBER(8,2),
 TIMING_ANOMALY_SCORE NUMBER(8,2),
 AMOUNT_ANOMALY_LEVEL VARCHAR(30),
 TIMING_ANOMALY_LEVEL VARCHAR(30),
 VELOCITY_ANOMALY_LEVEL VARCHAR(30),
 IS_LARGE_TRANSACTION BOOLEAN,
 IS_UNUSUAL_WEEKEND_TRANSACTION BOOLEAN,
 IS_OFF_HOURS_TRANSACTION BOOLEAN,
 SETTLEMENT_DAYS NUMBER(3,0),
 IS_DELAYED_SETTLEMENT BOOLEAN,
 IS_BACKDATED_SETTLEMENT BOOLEAN,
 COMPOSITE_ANOMALY_SCORE NUMBER(8,2),
 OVERALL_ANOMALY_CLASSIFICATION VARCHAR(30),
 REQUIRES_IMMEDIATE_REVIEW BOOLEAN,
 REQUIRES_ENHANCED_MONITORING BOOLEAN,
 TRANSACTIONS_LAST_24H NUMBER(5,0),
 TRANSACTIONS_LAST_7D NUMBER(5,0),
 TRANSACTION_HOUR NUMBER(2,0),
 TRANSACTION_DAYOFWEEK NUMBER(1,0),
 ANOMALY_ANALYSIS_TIMESTAMP TIMESTAMP_NTZ
...
DEFINE DYNAMIC TABLE {{ db }}.{{ pay_agg }}.PAYA_AGG_DT_ACCOUNT_BALANCES(
 ...
 CURRENT_BALANCE_BASE DECIMAL(18,2),
 TOTAL_CREDITS_BASE DECIMAL(18,2),
 TOTAL_DEBITS_BASE DECIMAL(18,2),
 CURRENT_BALANCE_BASE_CURRENCY DECIMAL(18,2),
 TOTAL_TRANSACTIONS NUMBER(10,0),
 CREDIT_TRANSACTIONS NUMBER(10,0),
 DEBIT_TRANSACTIONS NUMBER(10,0),
 AVG_TRANSACTION_AMOUNT_BASE DECIMAL(18,2),
 MIN_TRANSACTION_AMOUNT_BASE DECIMAL(18,2),
 MAX_TRANSACTION_AMOUNT_BASE DECIMAL(18,2),
 ACTIVITY_LEVEL VARCHAR(20),
 BALANCE_CATEGORY VARCHAR(20),
 IS_OVERDRAWN BOOLEAN,
 IS_DORMANT BOOLEAN,
 HAS_LARGE_RECENT_MOVEMENTS BOOLEAN,
 FIRST_TRANSACTION_DATE DATE,
 LAST_TRANSACTION_DATE DATE,
 LAST_VALUE_DATE DATE,
 RECENT_TRANSACTIONS_30D NUMBER(10,0),
 RECENT_BALANCE_CHANGE_30D_BASE DECIMAL(18,2),
 BALANCE_CALCULATION_TIMESTAMP TIMESTAMP_NTZ
...
DEFINE DYNAMIC TABLE {{ db }}.{{ pay_agg }}.PAYA_AGG_DT_CUSTOMER_TRANSACTION_SUMMARY(
 ...
 TOTAL_TRANSACTIONS_12M NUMBER(10,0),
 ...
 TRANSACTION_MONTHS_ACTIVE NUMBER(10,0),

 IS_DORMANT_TRANSACTIONALLY BOOLEAN,
 IS_HIGHLY_ACTIVE BOOLEAN,

 SUMMARY_AS_OF_DATE TIMESTAMP_NTZ
