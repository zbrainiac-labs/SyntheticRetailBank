...
GRANT USAGE ON DATABASE ${SOURCE_DATABASE} TO ROLE PUBLIC;

GRANT USAGE ON SCHEMA ${SOURCE_DATABASE}.${CMD_AGG} TO ROLE PUBLIC;

GRANT USAGE ON SCHEMA ${SOURCE_DATABASE}.${CRM_AGG} TO ROLE PUBLIC;

GRANT USAGE ON SCHEMA ${SOURCE_DATABASE}.${EQT_AGG} TO ROLE PUBLIC;

GRANT USAGE ON SCHEMA ${SOURCE_DATABASE}.${FII_AGG} TO ROLE PUBLIC;

GRANT USAGE ON SCHEMA ${SOURCE_DATABASE}.${LOA_AGG} TO ROLE PUBLIC;

GRANT USAGE ON SCHEMA ${SOURCE_DATABASE}.${PAY_AGG} TO ROLE PUBLIC;

GRANT USAGE ON SCHEMA ${SOURCE_DATABASE}.${REF_AGG} TO ROLE PUBLIC;

GRANT USAGE ON SCHEMA ${SOURCE_DATABASE}.${REP_AGG} TO ROLE PUBLIC;
...
DROP DATABASE if exists ${SOURCE_DATABASE}_REF_DAP_GLOBAL_SANCTIONS_DATA_SET;

USE DATABASE ${SOURCE_DATABASE};
USE SCHEMA PUBLIC;

CREATE OR REPLACE DATABASE ${SOURCE_DATABASE}_REF_DAP_GLOBAL_SANCTIONS_DATA_SET_COPY
...
LEFT JOIN ${SOURCE_DATABASE}.${CRM_AGG}.CRMA_AGG_DT_CUSTOMER_360 c
...
tables (
  ...
  customers AS ${SOURCE_DATABASE}.${CRM_AGG}.CRMA_AGG_DT_CUSTOMER_360
    PRIMARY KEY (CUSTOMER_ID)
...
tables (
  ...
  customers AS ${CRM_AGG}.CRMA_AGG_DT_CUSTOMER_360
    PRIMARY KEY (CUSTOMER_ID)
...
CREATE OR REPLACE AGENT CRM_Customer_360
  ...
  tool_resources:
    CRM_Customer_360:
      semantic_view: ${SOURCE_DATABASE}.${CRM_AGG}.CRMA_SV_CUSTOMER_360
    ...
    Advisor_Performance:
      semantic_view: ${SOURCE_DATABASE}.${CRM_AGG}.EMPA_SV_EMPLOYEE_ADVISOR
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
...
GRANT USAGE ON AGENT ${SOURCE_DATABASE}.${CRM_AGG}.CRM_Customer_360 TO ROLE ACCOUNTADMIN;
GRANT USAGE ON AGENT ${SOURCE_DATABASE}.${CRM_AGG}.CRM_Customer_360 TO ROLE PUBLIC;

CREATE SNOWFLAKE INTELLIGENCE IF NOT EXISTS SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT;

GRANT USAGE ON SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT TO ROLE PUBLIC;

ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT ADD AGENT ${SOURCE_DATABASE}.${CRM_AGG}.CRM_Customer_360;
...
CREATE OR REPLACE AGENT COMPLIANCE_MONITORING_AGENT
  ...
  tool_resources:
    Compliance_Monitoring:
      semantic_view: ${SOURCE_DATABASE}.${PAY_AGG}.PAYA_SV_COMPLIANCE_MONITORING
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
...
GRANT USAGE ON AGENT ${SOURCE_DATABASE}.${PAY_AGG}.COMPLIANCE_MONITORING_AGENT TO ROLE ACCOUNTADMIN;
GRANT USAGE ON AGENT ${SOURCE_DATABASE}.${PAY_AGG}.COMPLIANCE_MONITORING_AGENT TO ROLE PUBLIC;

CREATE SNOWFLAKE INTELLIGENCE IF NOT EXISTS SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT;

GRANT USAGE ON SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT TO ROLE PUBLIC;

ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT ADD AGENT ${SOURCE_DATABASE}.${PAY_AGG}.COMPLIANCE_MONITORING_AGENT;

SHOW AGENTS IN SCHEMA ${SOURCE_DATABASE}.${PAY_AGG};
SHOW SNOWFLAKE INTELLIGENCES;
...
CREATE OR REPLACE AGENT RISK_REGULATORY_AGENT
  ...
  tool_resources:
    Risk_Reporting:
      semantic_view: ${SOURCE_DATABASE}.${REP_AGG}.REPA_SV_RISK_REPORTING
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
    ...
    Compliance_Context:
      ...
      execution_environment:
        ...
        query_timeout: 30
    Wealth_Context:
      semantic_view: ${SOURCE_DATABASE}.${REP_AGG}.REPA_SV_WEALTH_MANAGEMENT
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
...
GRANT USAGE ON AGENT ${SOURCE_DATABASE}.${REP_AGG}.RISK_REGULATORY_AGENT TO ROLE ACCOUNTADMIN;
GRANT USAGE ON AGENT ${SOURCE_DATABASE}.${REP_AGG}.RISK_REGULATORY_AGENT TO ROLE PUBLIC;

CREATE SNOWFLAKE INTELLIGENCE IF NOT EXISTS SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT;

GRANT USAGE ON SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT TO ROLE PUBLIC;

ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT ADD AGENT ${SOURCE_DATABASE}.${REP_AGG}.RISK_REGULATORY_AGENT;

SHOW AGENTS IN SCHEMA ${SOURCE_DATABASE}.${REP_AGG};
SHOW SNOWFLAKE INTELLIGENCES;
...
GRANT USAGE ON AGENT ${SOURCE_DATABASE}.${REP_AGG}.WEALTH_ADVISOR_AGENT TO ROLE ACCOUNTADMIN;
GRANT USAGE ON AGENT ${SOURCE_DATABASE}.${REP_AGG}.WEALTH_ADVISOR_AGENT TO ROLE PUBLIC;

CREATE SNOWFLAKE INTELLIGENCE IF NOT EXISTS SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT;

GRANT USAGE ON SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT TO ROLE PUBLIC;

ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT ADD AGENT ${SOURCE_DATABASE}.${REP_AGG}.WEALTH_ADVISOR_AGENT;
...
CREATE OR REPLACE AGENT LIQUIDITY_RISK_AGENT
  ...
  tool_resources:
    LCR_Current_Status:
      semantic_view: ${SOURCE_DATABASE}.${REP_AGG}.LCRS_SV_LCR_CURRENT
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
    ...
    HQLA_Portfolio:
      semantic_view: ${SOURCE_DATABASE}.${REP_AGG}.LCRS_SV_HQLA_BREAKDOWN
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
    ...
    Deposit_Outflows:
      semantic_view: ${SOURCE_DATABASE}.${REP_AGG}.LCRS_SV_OUTFLOW_BREAKDOWN
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
    ...
    LCR_Trend:
      semantic_view: ${SOURCE_DATABASE}.${REP_AGG}.LCRS_SV_TREND_90DAY
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
    ...
    Compliance_Alerts:
      semantic_view: ${SOURCE_DATABASE}.${REP_AGG}.LCRS_SV_ALERTS_ACTIVE
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
...
GRANT USAGE ON AGENT ${SOURCE_DATABASE}.${REP_AGG}.LIQUIDITY_RISK_AGENT TO ROLE ACCOUNTADMIN;
GRANT USAGE ON AGENT ${SOURCE_DATABASE}.${REP_AGG}.LIQUIDITY_RISK_AGENT TO ROLE PUBLIC;
...
ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT 
  ADD AGENT ${SOURCE_DATABASE}.${REP_AGG}.LIQUIDITY_RISK_AGENT;
...
CREATE OR REPLACE AGENT LOAN_PORTFOLIO_AGENT
  ...
  tool_resources:
    Portfolio_Summary:
      semantic_view: ${SOURCE_DATABASE}.${REP_AGG}.LOAS_SV_PORTFOLIO_CURRENT
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
    ...
    LTV_Risk_Analysis:
      semantic_view: ${SOURCE_DATABASE}.${REP_AGG}.LOAS_SV_LTV_DISTRIBUTION
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
    ...
    Application_Funnel:
      semantic_view: ${SOURCE_DATABASE}.${REP_AGG}.LOAS_SV_APPLICATION_FUNNEL
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
    ...
    Affordability_Assessment:
      semantic_view: ${SOURCE_DATABASE}.${REP_AGG}.LOAS_SV_AFFORDABILITY_ANALYSIS
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
    ...
    Compliance_Screening:
      semantic_view: ${SOURCE_DATABASE}.${REP_AGG}.LOAS_SV_COMPLIANCE_SCREENING
      execution_environment:
        type: warehouse
        warehouse: MD_TEST_WH
        query_timeout: 30
...
GRANT USAGE ON AGENT ${SOURCE_DATABASE}.${REP_AGG}.LOAN_PORTFOLIO_AGENT TO ROLE ACCOUNTADMIN;
GRANT USAGE ON AGENT ${SOURCE_DATABASE}.${REP_AGG}.LOAN_PORTFOLIO_AGENT TO ROLE PUBLIC;
...
ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT 
  ADD AGENT ${SOURCE_DATABASE}.${REP_AGG}.LOAN_PORTFOLIO_AGENT;
