...
| O3 | ~~Medium~~ | ~~**Column COMMENTs verbose**~~ | 1,591 | ~~Won't fix — business context needed for semantic views and AI agents~~ |
| O4 | ~~Medium~~ | ~~**Object-level COMMENTs verbose**~~ | 61 | ~~Won't fix — same reason~~ |
